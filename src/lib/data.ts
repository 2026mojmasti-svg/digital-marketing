...
export const PRODUCTS: Product[] = [
  {
    ...
    images: [
      { alt: "Wool trench coat, front view on model", tone: ["#C25E3A", "#8C4128"] },
      { alt: "Wool trench coat, styled with boots on location", tone: ["#8C4128", "#3A2013"] },
      { alt: "Wool trench coat, detail of belt and storm flap", tone: ["#D9784F", "#C25E3A"] },
      { alt: "Wool trench coat, back view", tone: ["#A64F30", "#5C2C19"] },
    ],
    limitedDrop: true,
    rating: 4.7,
    reviewCount: 3,
    reviews: [
      { id: "r1", author: "M. Alvarez", rating: 5, title: "Worth every cent", body: "The wool is substantial without being stiff. Runs true to size.", date: "2026-06-02" },
  ...
  },
  {
    ...
    images: [
      { alt: "Quilted field jacket, front view", tone: ["#3A3C2E", "#14120F"] },
      { alt: "Quilted field jacket, lifestyle shot walking", tone: ["#4A4D3A", "#242619"] },
      { alt: "Quilted field jacket, pocket detail", tone: ["#5C5F49", "#3A3C2E"] },
    ],
    rating: 4.5,
    reviewCount: 2,
    reviews: [
  ...
  },
  {
    ...
    images: [
      { alt: "Raw-hem blazer, front view", tone: ["#3A3C2E", "#14120F"] },
      { alt: "Raw-hem blazer, hem detail close-up", tone: ["#242619", "#14120F"] },
      { alt: "Raw-hem blazer, styled open over knitwear", tone: ["#4A4D3A", "#242619"] },
    ],
    rating: 4.8,
    reviewCount: 2,
    reviews: [
  ...
  },
  {
    ...
    images: [
      { alt: "Wide-leg wool trouser, front view", tone: ["#8C7A5E", "#4A3F2D"] },
      { alt: "Wide-leg wool trouser, walking motion shot", tone: ["#6E6259", "#2B2822"] },
    ],
    rating: 4.6,
    reviewCount: 2,
    reviews: [
  ...
  },
  {
    ...
    images: [
      { alt: "Brushed wool crewneck, front view", tone: ["#8C7A5E", "#4A3F2D"] },
      { alt: "Brushed wool crewneck, texture detail", tone: ["#A6947A", "#6E6259"] },
      { alt: "Brushed wool crewneck, styled layered look", tone: ["#4A3F2D", "#241E14"] },
    ],
    rating: 4.9,
    reviewCount: 3,
    reviews: [
  ...
  },
  {
    ...
    images: [
      { alt: "Cable-knit vest, front view", tone: ["#3A3C2E", "#14120F"] },
      { alt: "Cable-knit vest, layered styling shot", tone: ["#5C5F49", "#3A3C2E"] },
    ],
    rating: 4.4,
    reviewCount: 2,
    reviews: [
  ...
  },
  {
    ...
    images: [
      { alt: "Leather belt bag, product shot", tone: ["#2B2822", "#14120F"] },
      { alt: "Leather belt bag, worn on model", tone: ["#4A4130", "#2B2822"] },
    ],
    rating: 4.7,
    reviewCount: 2,
    reviews: [
  ...
  },
  {
    ...
    images: [
      { alt: "Oversized wool scarf, styled shot", tone: ["#C25E3A", "#8C4128"] },
      { alt: "Oversized wool scarf, fringe detail", tone: ["#D9784F", "#C25E3A"] },
    ],
    rating: 4.8,
    reviewCount: 1,
