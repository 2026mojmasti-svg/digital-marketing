...
export const PRODUCTS: Product[] = [
  {
    ...
    images: [
      { alt: "Wool trench coat, front view flat sketch", tone: ["#C25E3A", "#8C4128"], garment: "trench", pattern: "plain", frame: "front", seed: 11, photo: "/images/charcoal-coat-street-style.jpg" },
      { alt: "Wool trench coat, worn on an illustrated figure", tone: ["#8C4128", "#3A2013"], garment: "trench", pattern: "plain", frame: "worn", seed: 12, photo: "/images/grey-trench-coat-closeup.jpg" },
      { alt: "Wool trench coat, fabric and belt detail", tone: ["#D9784F", "#C25E3A"], garment: "trench", pattern: "plain", frame: "detail", seed: 13, photo: "/images/oatmeal-coat-button-detail.jpg" },
  ...
  },
  {
    ...
    images: [
      { alt: "Quilted field jacket, front view flat sketch", tone: ["#4A4D3A", "#242619"], garment: "fieldjacket", pattern: "quilt", frame: "front", seed: 21, photo: "/images/bw-oversized-coat-editorial.jpg" },
      { alt: "Quilted field jacket, worn on an illustrated figure", tone: ["#3A3C2E", "#14120F"], garment: "fieldjacket", pattern: "quilt", frame: "worn", seed: 22, photo: "/images/bw-oversized-coat-editorial.jpg" },
  ...
  },
  {
    ...
    images: [
      { alt: "Raw-hem blazer, front view flat sketch", tone: ["#3A3C2E", "#14120F"], garment: "blazer", pattern: "pinstripe", frame: "front", seed: 31, photo: "/images/white-oversized-blazer-walking.jpg" },
      { alt: "Raw-hem blazer, worn on an illustrated figure", tone: ["#4A4D3A", "#242619"], garment: "blazer", pattern: "pinstripe", frame: "worn", seed: 32, photo: "/images/white-oversized-blazer-walking.jpg" },
  ...
  },
  {
    ...
    images: [
      { alt: "Brushed wool crewneck, front view flat sketch", tone: ["#8C7A5E", "#4A3F2D"], garment: "sweater", pattern: "rib", frame: "front", seed: 51, photo: "/images/brown-knit-sweater-hanger.jpg" },
      { alt: "Brushed wool crewneck, worn on an illustrated figure", tone: ["#A6947A", "#6E6259"], garment: "sweater", pattern: "rib", frame: "worn", seed: 52, photo: "/images/outfit-woman-crochet-cardigan.jpg" },
      { alt: "Brushed wool crewneck, ribbing texture detail", tone: ["#4A3F2D", "#241E14"], garment: "sweater", pattern: "rib", frame: "detail", seed: 53, photo: "/images/crochet-yarn-flatlay.jpg" },
    ],
    rating: 4.9,
    reviewCount: 3,
    reviews: [
  ...
  },
  {
    ...
    images: [
      { alt: "Cable-knit vest, front view flat sketch", tone: ["#3A3C2E", "#14120F"], garment: "vest", pattern: "rib", frame: "front", seed: 61, photo: "/images/crochet-cardigan-granny-square.jpg" },
      { alt: "Cable-knit vest, worn on an illustrated figure", tone: ["#5C5F49", "#3A3C2E"], garment: "vest", pattern: "rib", frame: "worn", seed: 62, photo: "/images/crochet-cardigan-granny-square.jpg" },
    ],
    rating: 4.4,
    reviewCount: 2,
    reviews: [
  ...
  },
  {
    ...
    images: [
      { alt: "Leather belt bag, flat sketch", tone: ["#2B2822", "#14120F"], garment: "beltbag", pattern: "plain", frame: "front", seed: 71, photo: "/images/black-crossbody-bag-detail.jpg" },
      { alt: "Leather belt bag, worn on an illustrated figure", tone: ["#4A4130", "#2B2822"], garment: "beltbag", pattern: "plain", frame: "worn", seed: 72, photo: "/images/black-crossbody-bag-detail.jpg" },
    ],
    rating: 4.7,
    reviewCount: 2,
    reviews: [
  ...
  },
  {
    ...
    images: [
      { alt: "Oversized wool scarf, styled flat sketch", tone: ["#C25E3A", "#8C4128"], garment: "scarf", pattern: "plain", frame: "front", seed: 81, photo: "/images/striped-knit-scarf.jpg" },
      { alt: "Oversized wool scarf, worn on an illustrated figure", tone: ["#D9784F", "#C25E3A"], garment: "scarf", pattern: "plain", frame: "worn", seed: 82, photo: "/images/striped-knit-scarf.jpg" },
    ],
    rating: 4.8,
    reviewCount: 1,
  ...
  },
  {
    ...
    images: [
      { alt: "Essential cotton tee, front view flat sketch", tone: ["#D8C9AE", "#B7A98A"], garment: "tee", pattern: "plain", frame: "front", seed: 91, photo: "/images/white-tee-terracotta-wall.jpg" },
      { alt: "Essential cotton tee, worn on an illustrated figure", tone: ["#B7A98A", "#8C7A5E"], garment: "tee", pattern: "plain", frame: "worn", seed: 92, photo: "/images/portrait-woman-white-tee-01.jpg" },
      { alt: "Essential cotton tee, fabric weave detail", tone: ["#C9BA9C", "#9C8C6A"], garment: "tee", pattern: "plain", frame: "detail", seed: 93, photo: "/images/tee-rack-six-colors.jpg" },
    ],
    rating: 4.6,
    reviewCount: 2,
    reviews: [
  ...
  },
  {
    ...
    images: [
      { alt: "Everyday poplin shirt, front view flat sketch", tone: ["#7C93A3", "#455A6B"], garment: "shirt", pattern: "pinstripe", frame: "front", seed: 101, photo: "/images/portrait-woman-striped-shirt-laptop.jpg" },
      { alt: "Everyday poplin shirt, worn on an illustrated figure", tone: ["#5C7285", "#33465A"], garment: "shirt", pattern: "pinstripe", frame: "worn", seed: 102, photo: "/images/portrait-woman-striped-shirt-laptop.jpg" },
  ...
  },
  {
    ...
    images: [
      { alt: "Straight-leg denim, front view flat sketch", tone: ["#3B4A5A", "#202B36"], garment: "denim", pattern: "denim", frame: "front", seed: 111, photo: "/images/denim-two-people-pulling-jeans.jpg" },
      { alt: "Straight-leg denim, worn on an illustrated figure", tone: ["#4A5A6A", "#28323C"], garment: "denim", pattern: "denim", frame: "worn", seed: 112, photo: "/images/denim-two-people-pulling-jeans.jpg" },
  ...
  },
  {
    ...
    images: [
      { alt: "Jersey wrap dress, front view flat sketch", tone: ["#C97A52", "#8C4128"], garment: "wrapdress", pattern: "plain", frame: "front", seed: 121, photo: "/images/cream-embroidered-dress.jpg" },
      { alt: "Jersey wrap dress, worn on an illustrated figure", tone: ["#B36840", "#6E3018"], garment: "wrapdress", pattern: "plain", frame: "worn", seed: 122, photo: "/images/cream-embroidered-dress.jpg" },
    ],
    rating: 4.6,
    reviewCount: 2,
    reviews: [
  ...
  },
  {
    ...
    limitedDrop: true,
    images: [
      { alt: "Sequin mini dress, front view flat sketch", tone: ["#1A1712", "#C9A227"], garment: "sequindress", pattern: "sequin", frame: "front", seed: 131, photo: "/images/woman-striped-shirt-black-skirt.jpg" },
      { alt: "Sequin mini dress, worn on an illustrated figure", tone: ["#241F17", "#B8931F"], garment: "sequindress", pattern: "sequin", frame: "worn", seed: 132, photo: "/images/woman-striped-shirt-black-skirt.jpg" },
  ...
  },
  {
    ...
    images: [
      { alt: "Satin slip dress, front view flat sketch", tone: ["#B98B8F", "#6E4448"], garment: "slipdress", pattern: "plain", frame: "front", seed: 141, photo: "/images/outfit-woman-pink-satin-dress.jpg" },
      { alt: "Satin slip dress, worn on an illustrated figure", tone: ["#A67378", "#5C363A"], garment: "slipdress", pattern: "plain", frame: "worn", seed: 142, photo: "/images/outfit-woman-pink-satin-dress.jpg" },
    ],
    rating: 4.5,
    reviewCount: 2,
    reviews: [
  ...
  },
  {
    ...
    variants: makeVariants(["Berry"]),
    images: [
      { alt: "Off-shoulder party top, front view flat sketch", tone: ["#7A2A3A", "#3E1420"], garment: "partytop", pattern: "plain", frame: "front", seed: 151, photo: "/images/outfit-woman-offshoulder-top-daily.jpg" },
      { alt: "Off-shoulder party top, worn on an illustrated figure", tone: ["#661F2C", "#2E0F18"], garment: "partytop", pattern: "plain", frame: "worn", seed: 152, photo: "/images/outfit-woman-offshoulder-top-daily.jpg" },
    ],
    rating: 4.4,
    reviewCount: 1,
  ...
  },
  {
    ...
    variants: makeVariants(["Ink"]),
    images: [
      { alt: "Tailored party jumpsuit, front view flat sketch", tone: ["#2E2A2E", "#14111A"], garment: "jumpsuit", pattern: "pinstripe", frame: "front", seed: 161, photo: "/images/eiffel-tower-black-skirt.jpg" },
      { alt: "Tailored party jumpsuit, worn on an illustrated figure", tone: ["#221E22", "#0E0C11"], garment: "jumpsuit", pattern: "pinstripe", frame: "worn", seed: 162, photo: "/images/eiffel-tower-black-skirt.jpg" },
