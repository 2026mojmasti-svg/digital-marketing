...
The buy box ends with a static list — free shipping over $250, free
...
progress bar against `FREE_SHIPPING_THRESHOLD` ($250) with the exact
remaining amount ("Add $32 more for free shipping").
